          ...
          <div className="grid gap-3 grid-cols-1 sm:grid-cols-3">
            ...
            >
              ...
              <div className="space-y-1 text-xs text-text-secondary">
                ...
                <p><strong>Индивидуальные дифавтоматы</strong> 10мА на стиральную, посудомоечную машину и водонагреватель.</p>
                <p className="text-green-400">✓ Сработал диф розеток — свет горит</p>
                <p className="text-green-400">✓ Водозависимые приборы на отдельных дифавтоматах 10мА</p>
